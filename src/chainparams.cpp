...
public:
    CMainParams() {
        ...
        vAlertPubKey = ParseHex("049874710fa689ad5023690c80f3a49c8f13f8d45b8c857fbcbc8bc4a8e4d3eb4b10f4d4604fa08dce601aaf0f470216fe1b51850b4acf21b179c45070ac7b03a9");
        nDefaultPort = 60808;
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // 3.5 days
        nTargetSpacing = 1 * 30; // 2.5 minutes
         ...
         *   vMerkleTree: 4a5e1e
         */
        const char* pszTimestamp = "Merel haar papa maakt een coin voor haar in september 2015";
        CMutableTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CScriptNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 50 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("049874710fa689ad5023690c80f3a49c8f13f8d45b8c857fbcbc8bc4a8e4d3eb4b9994d4604fa08dce601aaf0f470216fe1b51850b4acf21b179c45070ac7b03a9") << OP_CHECKSIG;
...
public:
    CTestNetParams() {
        ...
        vSeeds.push_back(CDNSSeedData("xurious.com", "testnet-seed.merel.xurious.com"));
